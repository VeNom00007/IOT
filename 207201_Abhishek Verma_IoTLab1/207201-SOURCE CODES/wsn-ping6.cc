...
int main (int argc, char **argv)
{
  ...
  ping6.SetRemote (i.GetAddress (9, 1));
  ...
  lrWpanHelper.EnableAsciiAll (ascii.CreateFileStream ("scratch/wsn-ping6.tr"));
  lrWpanHelper.EnablePcapAll (std::string ("scratch/wsn-ping6"), true);
